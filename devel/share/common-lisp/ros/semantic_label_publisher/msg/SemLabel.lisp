...
(cl:in-package semantic_label_publisher-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <SemLabel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SemLabel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name semantic_label_publisher-msg:<SemLabel> is deprecated: use semantic_label_publisher-msg:SemLabel instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <SemLabel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader semantic_label_publisher-msg:header-val is deprecated.  Use semantic_label_publisher-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'label-val :lambda-list '(m))
(cl:defmethod label-val ((m <SemLabel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader semantic_label_publisher-msg:label-val is deprecated.  Use semantic_label_publisher-msg:label instead.")
  (label m))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <SemLabel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader semantic_label_publisher-msg:r-val is deprecated.  Use semantic_label_publisher-msg:r instead.")
  (r m))

(cl:ensure-generic-function 'g-val :lambda-list '(m))
(cl:defmethod g-val ((m <SemLabel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader semantic_label_publisher-msg:g-val is deprecated.  Use semantic_label_publisher-msg:g instead.")
  (g m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <SemLabel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader semantic_label_publisher-msg:b-val is deprecated.  Use semantic_label_publisher-msg:b instead.")
  (b m))

(cl:ensure-generic-function 'prob-val :lambda-list '(m))
(cl:defmethod prob-val ((m <SemLabel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader semantic_label_publisher-msg:prob-val is deprecated.  Use semantic_label_publisher-msg:prob instead.")
  (prob m))

(cl:ensure-generic-function 'lvl-val :lambda-list '(m))
(cl:defmethod lvl-val ((m <SemLabel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader semantic_label_publisher-msg:lvl-val is deprecated.  Use semantic_label_publisher-msg:lvl instead.")
  (lvl m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SemLabel>)))
  ...
  "semantic_label_publisher/SemLabel")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SemLabel)))
  "Returns string type for a message object of type 'SemLabel"
  "semantic_label_publisher/SemLabel")
